...
<main class="dsn:relative">
    <div class="dsn:relative dsn:pb-2 dsn:md:pb-0">
        <div class="dsn:md:absolute dsn:top-0 dsn:bg-gray-100 dsn:w-full dsn:md:h-48 dsn:pb-1 dsn:md:pb-0 dsn:pt-10 dsn:text-center dns:px-3">
            <h1 class="dsn:text-4xl">
                <?php echo the_title(); ?>
                <?php //the_field('short_description_title'); 
                ?></h1>
        </div>
    </div>
                        ...
                        <section class="dsn:mb-10">
                            ...
                            <div class="dsn:grid dsn:gap-4 dsn:grid-cols-1 dsn:mx-auto dsn:max-w-2xl dsn:md:max-w-full<?php if ($showForm) { ?> dsn:md:grid-cols-2<?php }  ?>">
                                <div>
                                    ...
                                    if (get_the_content()) {
                                        echo '<div class="dss-wordpress-content-wrapper"><div class="dss-wordpress-content">';
                                        the_content();
                                        echo '</div></div>';
                                    } else {
                                        the_content();
...
<style>
    ...
    <?php if (!$showForm) { ?>@media (min-width: 640px) {
        .promotion-details-image {
            min-width: 600px;
        }
    }
