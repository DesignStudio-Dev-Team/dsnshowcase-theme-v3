        ...
        <div class="dsn:md:px-5 dsn:pt-1 dsn:md:pt-0 dsn:container dsn:mx-auto dsn:block dsn:md:flex dsn:flex-wrap dsn:px-0 dsn:pb-10 dsn:relative dsn:z-10 dsn:md:justify-start dsn:text-white footer-inner">
                    ...
                    <?php endif; ?>
                        ...
                        <?php foreach ($locations as $location) : ?>
                            ...
                            <div class="dsn:flex dsn:flex-col dsn:lg:flex-row dsn:gap-6 dsn:justify-between">
								<div class="footer-address-body dsn:w-full dsn:md:w-5/12">
                                    ...
                                    if($hours): ?>
                                    <div class="dsn:relative dsn:w-full dsn:md:w-7/12 dsn:mt-4 dsn:md:mt-4 dsn:text-base dsn:lg:text-xl hours">
                                    <p class="dsn:m-0 dsn:text-base dsn:font-normal dsn:lg:text-xl dsn:mb-2">
												HOURS:
											</p>
                      ...
                      <?php if ($social_networks) : ?>
                          <?php foreach ($social_networks as $network) : ?>
                              ...
                              <?php if($network == 'Facebook') { ?>
                                  ...
                                  <img class="dsn:w-10 dsn:md:w-14" src="<?php echo get_template_directory_uri(); ?>/assets/svg/social/facebook.svg" alt="<?php echo $network; ?>" />
                                  </a>
                                  ...
                                  <img class="dsn:w-10 dsn:md:w-14" src="<?php echo get_template_directory_uri(); ?>/assets/svg/social/youtube.svg" alt="<?php echo $network; ?>" />
                                  </a>
                                  ...
                                  <img class="dsn:w-10 dsn:md:w-14" src="<?php echo get_template_directory_uri(); ?>/assets/svg/social/x.svg" alt="X" />
                                  </a>
                                  <?php } ?>
                              </div>
                          <?php endforeach; ?>
