...
<style>
	...
	.get-footer {
		background-image: url(https://hssofmusiccity.designstudio.host/wp-content/uploads/2025/04/Rectangle-36.webp);
		background-size: cover;
...
<footer id="dsFooter" class="dsn:relative dsn:clear-both dsn:z-0">
    ...
    <div class="footer-main bgImage">
        <div class="dsn:md:px-10 dsn:pt-1 dsn:md:pt-0 dsn:container dsn:mx-auto dsn:block dsn:md:flex dsn:flex-wrap dsn:px-0 dsn:pb-10 dsn:relative dsn:z-10 dsn:md:justify-start dsn:text-white">
                            ...
                            <h4 class="dsn:mt-4 dsn:font-bold m-0 dsn:text-base dsn:lg:text-2xl dsn:text-left"><?php echo esc_html($location['tab_title']); ?></h4>
								<div class="footer-address-body">
                                        <div class="dsn:mt-4 dsn:md:mt-4 dsn:text-base dsn:lg:text-xl dsn:w-full">
											<p class="dsn:m-0 dsn:text-base dsn:font-normal dsn:lg:text-xl">
												ADDRESS:
											</p>
                        ...
                        <?php if ($social_networks) : ?>
                            <?php foreach ($social_networks as $network) : ?>
                                ...
                                <?php if($network == 'Facebook') { ?>
                                    ...
                                    <img class="dsn:w-14" src="<?php echo get_template_directory_uri(); ?>/assets/svg/social/facebook.svg" alt="<?php echo $network; ?>" />
                                    </a>
                                    <?php } elseif ($network == 'Instagram') {?>
                                    <a href="<?php echo esc_url_raw(get_field('insta_url', 'option')); ?>">
                                    <img class="dsn:w-14" src="<?php echo get_template_directory_uri(); ?>/assets/svg/social/instagram.svg" alt="<?php echo $network; ?>" />
                                    </a>
                                    ...
                                    <img class="dsn:w-14" src="<?php echo get_template_directory_uri(); ?>/assets/svg/social/pinterest.svg" alt="<?php echo $network; ?>" />
                                    </a>
                                    <?php } ?>
                                </div>
                            <?php endforeach; ?>
