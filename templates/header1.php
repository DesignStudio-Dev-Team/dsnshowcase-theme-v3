...
<header class="dsn:bg-white dsn:text-[#0988c2] dsn:py-4 dsn:mb-10 dsn:hidden dsn:md:block <?php if($header_sticky == "1") {echo "dsn:sticky dsn:top-0 sticky-header";}else {echo "dsn:relative"; } ?>">
	<div class="dsn:container dsn:mx-auto dsn:flex dsn:justify-between dsn:items-center dsn:py-4 dsn-header-top-container">
	...
	<div class="primary-nav dsn:bg-gray-100 dsn:mt-4 dsn:block dsn:relative dsn:mx-auto">
	<div class="dsn-logo dsn:w-auto dsn:hidden">
		<a class="dsn:block dsn:relative dsn:text-center" href="<?php
            echo esc_url(home_url('/'));
        ?>"><img class="dsn:w-48 dsn:md:w-80 dsn:h-[64px] dsn:object-contain dsn:object-left dsn:mx-auto dsn:p-2" src="<?php echo $header_sticky_logo['url']; ?>" alt="<?php bloginfo('name'); ?>" /> <span class="dsn:hidden"> <?php bloginfo('name'); ?></span></a>
		</div>
	...
	<div class="cart-search-combo cf dsn:flex dsn:justify-end dsn:items-center dsn:gap-4 dsn:hidden dsn:text-white">
...
@media only screen and (min-width: 1024px) {
 ...
 <script>
              (function($) {
				...
				var clickable_desktop = $('.util-left-nav ul, .util-right-nav ul').attr('data-clickable');
				$('.util-left-nav ul li:has(ul), .util-right-nav ul li:has(ul)').addClass('has-sub dsn:relative dsn:flex dsn:items-center dsn:gap-2 dsn:cursor-pointer');
				$('.util-left-nav ul .has-sub>a, .util-right-nav ul .has-sub>a').after('<span class="dsn_nav__caret dsn:text-[#0988c2] dsn:rotate-90"><svg fill="currentColor" width="20" height="18" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512"><path fill="currentColor" d="M310.6 233.4c12.5 12.5 12.5 32.8 0 45.3l-192 192c-12.5 12.5-32.8 12.5-45.3 0s-12.5-32.8 0-45.3L242.7 256 73.4 86.6c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0l192 192z"/></svg></span>');
