...
#gform_wrapper_82 .gform_heading {display: none;}

#gform_wrapper_82 #input_82_1 .gchoice {
	width: 200px;
}

#gform_wrapper_82 #input_82_1 .gfield-choice-input {
	width: 20px;
	height: 20px;
}

#gform_wrapper_82 legend {
  padding: 0;
  font-size: 20px;
}
...
#gform_submit_button_82 {
  ...
  color: #fff;
	...
	#gform_82 .gform_footer.top_label {
		text-align: center;
	}
	#gform_wrapper_82 {
		color: #fff;
