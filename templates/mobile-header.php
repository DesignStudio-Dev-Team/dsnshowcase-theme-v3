<header class="mobile block dsn:md:hidden dsn:text-[#0988c2] dsn:border-b">
	<div class="dsn:flex dsn:justify-between dsn:px-4 dsn:py-4">
        ...
        ?>"><img class="dsn:w-48 dsn:md:w-64 dsn:mx-auto" src="<?php echo $header_logo['url']; ?>" alt="<?php bloginfo('name'); ?>" /> <span class="dsn:hidden"> <?php bloginfo('name'); ?></span></a></div><div class="dsn-mobile-icons dsn:flex dsn:items-center dsn:justify-end dsn:gap-4"><a class="the-search-icon"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="dsn:stroke-current dsn:fill-current dsn:cursor-pointer" width="25.927" height="25.927">
