                            ...
                            <?php foreach ($social_networks as $network) : ?>
                                <div class="dsn:flex dsn:items-center dsn:pb-10 dsn:md:pb-8 dsn:w-1/3 dsn:justify-center dsn:md:justify-start">
                                    <a href="<?php echo esc_url_raw($network['url']); ?>">
                                        <img class="dsn:h-10 dsn:w-auto dsn:md:h-12" src="<?php echo esc_url_raw($network['icon_url']); ?>" alt="<?php echo esc_html($network['social_network'] === 'Twitter' ? 'X' : $network['social_network']); ?>">
                                    </a>
                                </div>
                            <?php endforeach; ?>
                        <?php endif; ?>
