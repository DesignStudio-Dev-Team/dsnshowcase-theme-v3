...
<div
    class="dsn:container dsn:mx-auto dsn:grid dsn:md:flex dsn:md:flex-wrap dsn:grid-cols-1 dsn:sm:grid-cols-2 dsn:md:grid-cols-3 dsn:justify-between dsn:gap-2 dsn:order-2 dsn:mb-10">
    <?php
