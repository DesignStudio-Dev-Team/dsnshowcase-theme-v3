...
<div
    ...
    <div class="dsn:flex dsn:flex-col dsn:w-full dsn:md:flex-row dsn:flex-grow-1 dsn:basis-full dsn:gap-4 dsn:my-0 dsn:justify-center dsn:items-center dsn:px-0 dsn:md:px-0 dsn:py-2 dsn:col-span-1 dsn:sm:col-span-2 dsn:md:col-span-3 dsn:order-1 dsn:md:<?php echo $top_row_order; ?>">
    <?php
    ...
    ?>
                            <div
                                class="dsn:flex-auto dsn:w-full dsn:h-60 dsn:2xl:h-90 dsn:flex-grow-1 dsn:md:w-1/3 dsn:basis-0 dsn:transition-all dsn:duration-1000 dsn:hover:flex-grow-2 dsn:relative dsn:!bg-cover dsn:!bg-center dsn:order-2 dsn:md:<?php echo $top_row_order; ?>"
    ...
    <div 
        ...
        <h1 class="dsn:mb-0 dsn:text-center dsn:text-2xl dsn:lg:text-4xl dsn:font-medium <?php if ($text_color == 'black') {
                                                                                                echo 'dsn:text-black';
                                                                                            } else {
                                                                                                echo 'dsn:text-white';
                                                                                            } ?>"><?php echo $title; ?></h1><a
    ...
    if (have_rows('hero_2_content', $block_id)): ?> 
        <div class="dsn:flex dsn:flex-col dsn:w-full dsn:md:flex-row dsn:flex-grow-1 dsn:basis-full dsn:py-2 dsn:gap-4 dsn:justify-center dsn:items-center dsn:px-4 dsn:md:px-0 dsn:col-span-1 dsn:sm:col-span-2 dsn:md:col-span-3 dsn:order-1 dsn:md:<?php echo $bottom_row_order; ?>">
        <?php 
        while (have_rows('hero_2_content', $block_id)):
            the_row();
    ...
    ?>
                            <div
                                class="dsn:w-full dsn:h-60 dsn:2xl:h-90 dsn:flex-grow-1 dsn:md:w-1/3 dsn:basis-0 dsn:transition-all dsn:duration-1000 dsn:hover:flex-grow-2 dsn:relative dsn:!bg-cover dsn:!bg-center dsn:order-2 dsn:md:<?php echo $bottom_row_order; ?>"
                                style="background: url(<?php echo $card_image['url']; ?>);">
                                <a class="dsn:flex dsn:w-full dsn:h-full dsn:text-white dsn:items-end dsn:justify-center dsn:p-4 dsn:before:absolute dsn:before:w-full dsn:before:h-full dsn:before:left-0 dsn:before:top-0 dsn:before:opacity-80 dsn:before:bg-linear-to-b dsn:before:from-transparent dsn:before:to-black dsn:before:from-70%"
