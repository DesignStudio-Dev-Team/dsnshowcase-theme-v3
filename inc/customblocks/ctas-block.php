...
<section id="cta-block-<?php echo $block_id; ?>" style="background: url('<?php echo $bgImg; ?>') no-repeat center center; background-size: cover;" class="dsnctasBlock dsn:min-h-[245px] dsn:w-full dsn:block dsn:lg:flex dsn:gap-10 dsn:my-10 dsn:justify-center dsn:align-middle dsn:items-center">
    <?php if($cta_content) { ?><div class="dsnctasContent dsn:w-full dsn:lg:w-1/2 dsn:p-5 dsn:lg:p-10 dsn:lg:pt-25 dsn:block dsn:lg:flex dsn:flex-col">
    ...
    <div class="dsn:w-full dsn:lg:w-1/2 dsn:p-5 dsn:lg:p-10 dsn:justify-items-center dsn:justify-center dsn:flex dsn:flex-col">
        <?php if($cta1) { ?> <a class="btn dsn:mt-5 dsn:justify-center dsn:lg:justify-start dsn:lg:self-start" href="<?php echo $cta1['url']; ?>"><?php echo $cta1['title']; ?></a> <?php } ?>
        <?php if($cta2) { ?><a class="btn dsn:mt-5 dsn:justify-center dsn:lg:justify-start dsn:lg:self-start" href="<?php echo $cta2['url']; ?>"><?php echo $cta2['title']; ?></a><?php } ?>
    </div>
</section>
