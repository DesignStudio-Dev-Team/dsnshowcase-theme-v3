...
<div class="account-header">
	<div class="account-header-inner">
		...
		<div class="content-title">
				<h2><?php echo dssLang($dssSiteLanguage)->my_account->menu->addresses; ?> (<?php echo count($get_addresses); ?>)</h2>
		...
		<div class="welcome-title">
			<p class="right-mobile"><?php echo count($get_addresses); ?> Addresses</p>
